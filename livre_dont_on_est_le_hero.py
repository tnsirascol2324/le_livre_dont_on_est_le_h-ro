...
while True:
    ...
    if choix in cle:
        ...
        #c'est pas grave car l'histoire est faite main donc un copié collé est possible mais double le nombre de chose a écrire
        #etats  if etat = 1  alos jouer mort supp pv et degat
